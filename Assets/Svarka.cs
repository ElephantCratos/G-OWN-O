...
namespace BNG {
    ...
    /// </summary>
    public class Svarka : GrabbableEvents {
    ...
    if(hit.collider != null) {
        if (CollisionParticle != null) {
            ...
            // 🎯 Добавляем логику латания
            var patchable = hit.collider.GetComponent<PatchableHole>();
            if (patchable != null) {
                patchable.ApplyRepair(30f); // скорость заварки: 30% в секунду
            }
        }
    }
    else {
